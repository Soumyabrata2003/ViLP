...
def epoch_saving(epoch, model, model_pose, video_head, optimizer, filename):
    torch.save({
                    'epoch': epoch,
                    'model_state_dict': model.state_dict(),
                    'model_pose_state_dict': model_pose.state_dict(),
                    'fusion_model_state_dict': video_head.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict(),
                    }, filename) #just change to your preferred folder/filename

def best_saving(working_dir, epoch, model, model_pose, video_head, optimizer):
